...
export default function Home() {
  ...
  return<div
  className="w-full h-screen overflow-hidden bg-black pt-6 px-6 lg:px-10 bg-[url('/images/ring-light.webp')] bg-cover bg-no-repeat"
>
  <nav>
  ...
  <main className="flex w-[60%] py-30 h-full">
    <div>
      <h1 className="text-3xl pr-10 lg:text-5xl font-bold text-shadow-2xs text-shadow-white">
  ...
  <div className="absolute -bottom-10 left-0 w-56 drop-shadow-2xl h-56 blur-[50px] bg-purple-500"></div>
  <div className="absolute z-[-1] overflow-visible -top-20 right-0 rotate-[20deg] scale-125">
